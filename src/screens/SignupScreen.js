...
import { StyleSheet, Text, View, TextInput, TouchableOpacity, ScrollView, Button, Alert ,ImageBackground} from 'react-native';
...
<ImageBackground source={secImage} resizeMode="cover" style={styles.image}>
        ...
        <View style={styles.inputView}>
          <View style={styles.inputBox}>
            ...
            <TextInput value={name} onChangeText={(e) => setName(e)}
              style={styles.TextInput} placeholder='First name'  color='black' ></TextInput>
        ...
        <View style={styles.inputView}>
          <View style={styles.inputBox}>
            ...
            <TextInput value={phone} onChangeText={(e) => setPhone(e)}
              style={styles.TextInput} placeholder='Phone' ></TextInput>
          </View>
        </View>
        <View style={{right:10,bottom:20}}> 
            {phoneError.length > 0 &&
        ...
        <View style={styles.inputView}>
          <View style={styles.inputBox}>
            ...
            <TextInput value={email} onChangeText={(e) => setEmail(e)}
              style={styles.TextInput} placeholder='Email' autoCapitalize='none'
              keyboardType='email-address' autoComplete='email'></TextInput>
          </View>
        </View>
        <View style={{right:40,bottom:20}}> 
            {emailError.length > 0 &&
        ...
        <View style={styles.inputView}>
          <View style={styles.inputBox}>
            ...
            <TextInput value={password} onChangeText={(e) => setPassword(e)}
              style={styles.TextInput} placeholder='Password'  secureTextEntry={true}></TextInput>
          </View>
        </View>
      ...
      >
        <Text >{loading ? 'Loading...' : 'Login'}</Text>
          ...
          <Text style={styles.forgot_button} >Already have a account? </Text>
          <TouchableOpacity  onPress={() => navigation.navigate('LoginScreen')}>
            <Text style={styles.forgot_buttons} >Login</Text>
          </TouchableOpacity>
        </View>
